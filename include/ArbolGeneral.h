...
*
* Una instancia de este TDA debe cumplir los siguientes requisitos:
* - La raiz no debe tener nodo padre ni hermano a la derecha.
* - Las hojas deben tener nodo hijo.
* - Las etiquetas de los nodos deben ser todas del tipo Tbase.
*
* @section faConjunto Función de abstracción
*
* Una instancia de este TDA representa una estructura de árbol
*
*/
...
private:
    ...
    * padre-hijoizquierda-hermanoderecha.
    */
    struct nodo {
    ...
    *
    * Etiqueta que corresponde a este nodo.
    */
    Tbase etiqueta;
    ...
    */
    ...
    /**
    * @brief Puntero al hermano a la derecha.
    */
    nodo *drcha;
    ...
    */
    nodo() : hijo(NULL), drcha(NULL), padre(NULL) {};
    };
    ...
    * del árbol. Vale NULL sin el árbol es vacío.
    */
    struct nodo *laraiz;
    ...
    *
    * Destruye el subárbol que cuelga de n, así como el propio n.
    */
    ...
    * @param n Nodo del que cuelga el subárbol de nodos a contar.
    *
...
public:
    ...
    * La operación se realiza en tiempo O(1).
    */
    Nodo hijoIzquierda(const Nodo n) const;
    ...
    */
    void asignarSubarbol(const ArbolGeneral<Tbase>& orig, Nodo nod);
    ...
    *  La operación se realiza en tiempo O(1).
    */
    void podarHijoIzquierda(Nodo n, ArbolGeneral<Tbase> &dest);
    ...
    */
    void insertarHijoIzquierda(Nodo n, ArbolGeneral<Tbase>& rama);
